<h2>Howdy fella! I'm Claudio Pasinelli! <img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"></h2>
...
<p>
  ...
  <img src="https://giphy.com/stickers/coffee-break-KazYtoXQkYy6BlkOwG" width="30">
  </em>
</p>
...
### <img src="https://media.giphy.com/media/VgCDAzcKvsR6OM0uWg/giphy.gif" width="75"> A little more about me... ### <img src="https://media.giphy.com/media/YXLItYxo0H35b06ZMU/giphy.gif" width="75">

```javascript
const claudio = {
  code: [Javascript, Typescript, CSS, HTML, Java],
  tools: [React, Redux, Tailwind, ESLint],
  videoGames: [
    RimWorld,
    StarCraft_II,
    Project_Zomboid,
